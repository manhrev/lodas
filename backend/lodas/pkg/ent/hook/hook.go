...
// The BetSettingFunc type is an adapter to allow the use of ordinary
// function as BetSetting mutator.
type BetSettingFunc func(context.Context, *ent.BetSettingMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f BetSettingFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.BetSettingMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.BetSettingMutation", m)
}
...
// The SheetFunc type is an adapter to allow the use of ordinary
// function as Sheet mutator.
type SheetFunc func(context.Context, *ent.SheetMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f SheetFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SheetMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.SheetMutation", m)
}
